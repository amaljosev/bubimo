...
/// The Diary tab's content. Its [DiaryListBloc] is provided by [MainShell]
/// (created once, kept alive across tab switches) — this widget only
/// consumes it via [BlocBuilder]/[context.read], it does not create it.
...
class _HomeViewState extends State<_HomeView> {
  ...
  @override
  Widget build(BuildContext context) {
    // No Scaffold/AppBar here — MainShell provides both. This Scaffold
    // exists only to host the FAB; it's transparent otherwise and does
    // not add its own AppBar.
    return Scaffold(
      body: Column(
        children: [
